...
public class MyUser {
	private String firstName, lastName, email, dob, password, contact, organisation;
	private int id;
	
	public MyUser(int id, String fName, String lName, String email, String dob, String password, String contact, String organisation) {
		this.id = id;
		firstName = fName;
		lastName = lName;
		this.email = email;
