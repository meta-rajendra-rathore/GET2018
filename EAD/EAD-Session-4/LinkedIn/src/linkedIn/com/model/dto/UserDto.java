...
public class UserDto {
	private String firstName, lastName, email, dob, contact, organisation, image;
	private int id;
	
	public UserDto(int id, String fName, String lName, String email, String dob, String contact, String organisation, String image) {
		this.id = id;
		firstName = fName;
		lastName = lName;
		this.email = email;
