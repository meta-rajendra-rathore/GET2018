...
public class ShowProfile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UserDto user = MyUserDaoMySQL.getInstance().searchEmployeeByEmail(request.getParameter("email")); 
		System.out.println("hii bro" + user.getFirstName()); 
		...
		out.write("' alt='User Image' width=60px id='user_image' style='cursor: pointer'/> "
				+ "<span id='spnFilePath'></span> <input type='file' id='FileUpload' style='display: none' /> "
		...
		out.write("' alt='User Image' id='upload_image' width=80px border='1' border-color='indianred'/></td><br /> <td align='right' style='font-size:25px'>");
		...
		out.write("</td> </tr> <tr> <td>Organization/Institute : </td> <td align='right'>");
		
		out.write(user.getOrganisation());
		
		out.write("</td> </tr> <tr> <td></td> <td align='right'><br><input type='button' onclick='UpdateEmployee' value=' Edit Profile ' id='button_new_user'></td> </tr> </table> </div> </body> </html>");
	}
