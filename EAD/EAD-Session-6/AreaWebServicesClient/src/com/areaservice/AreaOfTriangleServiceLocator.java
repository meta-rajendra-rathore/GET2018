...
public class AreaOfTriangleServiceLocator extends org.apache.axis.client.Service implements com.areaservice.AreaOfTriangleService {
    ...
    private java.lang.String AreaOfTriangle_address = "http://localhost:8080/AreaWebServices/services/AreaOfTriangle";
    ...
    public com.areaservice.AreaOfTriangle getAreaOfTriangle() throws javax.xml.rpc.ServiceException {
    ...
    public com.areaservice.AreaOfTriangle getAreaOfTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.areaservice.AreaOfTriangleSoapBindingStub _stub = new com.areaservice.AreaOfTriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.areaservice.AreaOfTriangle.class.isAssignableFrom(serviceEndpointInterface)) {
                com.areaservice.AreaOfTriangleSoapBindingStub _stub = new com.areaservice.AreaOfTriangleSoapBindingStub(new java.net.URL(AreaOfTriangle_address), this);
                _stub.setPortName(getAreaOfTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://areaservice.com", "AreaOfTriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://areaservice.com", "AreaOfTriangle"));
        }
